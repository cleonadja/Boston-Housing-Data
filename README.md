# Boston-Housing-Data
## Domain
This problem is drawn from the analysis census demo graphic data. Similar analysis has been done when it come to the gender pay gap or when it comes to assessing demographic data by tax bracket. Sample source: https://docs.microsoft.com/en-us/azure/machine-learning/preview/scenario-tdsp-classifying-us-incomes
